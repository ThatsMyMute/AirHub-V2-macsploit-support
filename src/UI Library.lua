...
library.gradient = base64decode("")
...
function library.createcolorpicker(default, defaultalpha, parent, count, flag, callback)
	...
	local alphaicon = utility.create("Image", {
		...
		ZIndex = 9,
		Parent = icon,
		Data = base64decode("iVBORw0KGgoAAAANSUhEUgAAABIAAAAKBAMAAABLZROSAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAGUExURb+/v////5nD/3QAAAAJcEhZcwAADsMAAA7DAcdvqGQAAAAVSURBVBjTY2AQhEIkliAWSLY6QQYAknwC7Za+1vYAAAAASUVORK5CYII=")
	})
